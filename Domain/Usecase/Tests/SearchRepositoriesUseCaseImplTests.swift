...
struct SearchRepositoriesUseCaseImplTests {
    ...
    private typealias SearchResult = (totalCount: Int, items: [(id: Int, name: String, htmlURL: String, ownerLogin: String, ownerAvatarURL: String)])
    ...
    func execute_success_mapsDTOToEntity() async throws {
        ...
        let (sut, mock) = Self.makeSUT { _, _ in
            (totalCount: 42, items: [(id: 1, name: "swift-repo", htmlURL: "https://github.com/apple/swift", ownerLogin: "apple", ownerAvatarURL: "https://avatars.githubusercontent.com/u/1")])
        }
    ...
    func execute_multipleItems_mapsAllCorrectly() async throws {
        ...
        let (sut, _) = Self.makeSUT { _, _ in
            (totalCount: 100, items: [
                (id: 1, name: "repo-alpha", htmlURL: "https://github.com/org/repo-alpha", ownerLogin: "org", ownerAvatarURL: "https://avatars.example.com/org"),
                (id: 2, name: "repo-beta", htmlURL: "https://github.com/user/repo-beta", ownerLogin: "user", ownerAvatarURL: "https://avatars.example.com/user"),
                (id: 3, name: "repo-gamma", htmlURL: "https://github.com/team/repo-gamma", ownerLogin: "team", ownerAvatarURL: "https://avatars.example.com/team"),
            ])
        }
        ...
        #expect(result.items == [
            RepositoryEntity(id: 1, name: "repo-alpha", htmlURL: "https://github.com/org/repo-alpha", ownerLogin: "org", ownerAvatarURL: "https://avatars.example.com/org"),
            RepositoryEntity(id: 2, name: "repo-beta", htmlURL: "https://github.com/user/repo-beta", ownerLogin: "user", ownerAvatarURL: "https://avatars.example.com/user"),
            RepositoryEntity(id: 3, name: "repo-gamma", htmlURL: "https://github.com/team/repo-gamma", ownerLogin: "team", ownerAvatarURL: "https://avatars.example.com/team"),
        ])
    }
